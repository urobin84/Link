...
const ModalShare = (props: ModalShareProps) => {
  ...
  return (
    <div
      ...
      className="hs-overlay hs-overlay-open:translate-y-0 translate-y-full fixed bottom-0 inset-x-0 transition-all duration-300 transform max-h-[45vh] h-full w-full z-[60] bg-white border-b hidden rounded-xl rounded-t-10"
      tabIndex={-1}
    >
      ...
      <div className="p-4">
        ...
        <div className="flex relative mt-2">
          ...
          <input
            type="search"
            id="search"
            className="block w-full p-4 ps-10 text-sm text-gray-700 border border-gray-300 rounded-lg bg-gray-50 focus:ring-transparent focus:border-transparent dark:bg-transparent dark:border-transparent dark:placeholder-gray-400 dark:focus:ring-transparent dark:focus:border-transparent"
            placeholder="link"
            value={linkContent}
            required
          />
